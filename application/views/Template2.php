...
<head>
    ...
    <!-- Bootstrap core CSS     -->
    <link href="<?php echo base_url('assets/pelamar/css/bootstrap.min.css') ?>" rel="stylesheet" />

    <!-- Animation library for notifications   -->
    <link href="<?php echo base_url('assets/pelamar/css/animate.min.css') ?>" rel="stylesheet"/>

    <!--  Light Bootstrap Table core CSS    -->
    <link href="<?php echo base_url('assets/pelamar/css/light-bootstrap-dashboard.css?v=1.4.0') ?>" rel="stylesheet"/>


    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="<?php echo base_url('assets/pelamar/css/demo.css') ?>" rel="stylesheet" />


    <!--     Fonts and icons     -->
    <link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Roboto:400,700,300' rel='stylesheet' type='text/css'>
    <link href="<?php echo base_url('assets/pelamar/css/pe-icon-7-stroke.css') ?>" rel="stylesheet" />
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="<?php echo site_url('pelamar/Auth/logOut') ?>">
                                <p>Log out</p>
                            </a>
                        </li>
